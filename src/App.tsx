...
const App = () => (<>
  ...
  />
  <div style={{ display: 'flex', justifyContent: 'center', paddingBottom: '32px' }}>v1.0.0. Made by<a href="https://github.com/rconjoe">&nbsp;rconjoe</a>. Not affiliated with Launders' LAN.</div>
</>);
